...
class CameraOverlayView @JvmOverloads constructor(
    ...
    init {
        ...
        aspectRatio =
            typedArray.getFloat(R.styleable.CameraOverlayView_aspectRatio, DEFAULT_DIMENSION)
        topMarginPercent = typedArray.getFloat(
            R.styleable.CameraOverlayView_topMarginPercent,
            DEFAULT_MARGIN_TOP_PERCENT
        )
        horizontalMarginPercent = typedArray.getFloat(
            R.styleable.CameraOverlayView_horizontalMarginPercent,
            DEFAULT_MARGIN_HORIZONTAL_PERCENT
        )
        strokeWidth =
            typedArray.getFloat(R.styleable.CameraOverlayView_widthStroke, DEFAULT_STROKE_WIDTH)
        strokeColor =
            typedArray.getColor(R.styleable.CameraOverlayView_colorStroke, DEFAULT_STROKE_COLOR)
        backgroundColor = typedArray.getColor(
            R.styleable.CameraOverlayView_colorBackground,
    ...
    private fun getFrameRecF(): RectF {
